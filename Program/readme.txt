...
The problem lies in the difference of the compilers and the different set of libraries on your machine, and the machine where was statically compiled this .exe file.
